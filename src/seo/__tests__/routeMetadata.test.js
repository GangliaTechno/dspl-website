  ...
  it('defines the approved Copy Deck SEO titles and descriptions across all public routes', () => {
    const expected = {
      ...
      '/brands': {
        ...
        description: 'Raw Radicles is the first consumer brand from Dashapatmaja Solutions Pvt Ltd: six 60 g Ayurvedic chocolate bars across three collections, built end to end in India.',
      },
      '/brands/raw-radicles': {
        title: 'Raw Radicles: Ayurvedic Chocolate Built from Scratch in India',
        description: 'Six 60 g Ayurvedic chocolate bars built from formulation brief to print-ready pack: Holy Sin, Wrath Relief and Smart Sin, by Dashapatmaja Solutions Pvt Ltd in Manipal.',
      },
      '/branding': {
      ...
      '/contact': {
        ...
        description: 'Talk to Dashapatmaja Solutions Pvt Ltd in Manipal about branding, marketing, e-commerce or a new consumer brand. We reply within one working day.',
      },
      '/start': {
