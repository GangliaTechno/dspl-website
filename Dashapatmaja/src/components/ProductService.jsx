      ...
      <div className="w-full bg-gray-100 py-10 flex flex-col items-center">
        ...
        <section className="text-center mt-10">
          ...
          <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
            The GenAlpha Portable Lab bridges gaps in STEM education, enhances problem-solving
            skills, and promotes innovation among students and educators. It’s a transformative tool
