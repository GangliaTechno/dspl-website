...
| `about-journey-v2-{2022,2023,2024,2025,2026}.webp`; masters `docs/assets/journey-masters/about-journey-v2-{2022,2023,2024,2025,2026}.png` | Five newly generated originals; 2023, 2025, and 2026 received targeted built-in edits before deterministic 1536 x 1024 WebP derivatives were created with local Sharp | OpenAI built-in image generation | 2026-08-14 | Approved collection and year prompts below; labelled local references were used only for palette, material, subject-stage, product-form, or semantic guidance | Reviewed side by side: five distinct compositions and milestone narratives; rejected initial 2023 and 2025 drafts with synthetic text-like marks and strengthened the 2026 campaign zone; selected masters contain no readable text, copied marks, recognizable people, public figures, third-party photography, or watermark | Direction and full regeneration approved by user; responsive browser QA passed at 1440 x 900 and 390 x 844 |
...
| `marketing-dashboard-mobile-hq.webp` | High-fidelity edit of `marketing-dashboard-mobile.webp`; original retained | OpenAI built-in image generation | 2026-08-13 | Preserve the exact portrait city, avenue, skyline, billboard, vehicle, lighting, and colour composition; improve only resolution and photographic clarity | Compared with the source: same scene and crop; no new brand, readable campaign copy, or watermark | Approved by user; final responsive QA required |
| `ecommerce-dashboard-mobile-hq.webp` | High-fidelity edit of `ecommerce-dashboard-mobile.webp`; original retained | OpenAI built-in image generation | 2026-08-13 | Preserve the exact portrait dashboard, laptop, phone, chart, object, lighting, and colour composition; improve only resolution and interface clarity | Compared with the source: same scene and crop; no new brand or watermark | Approved by user; final responsive QA required |
...
All five assets used the `photorealistic-natural` generation mode. Every local
input was a reference image, never an edit target. The existing journey images
remain in the repository for provenance and rollback.

### 2022 - Company incorporation

Reference roles:

- `icon_orange.webp`: palette only; the logo was prohibited from the output.
- `about-journey-2023.webp`: lighting and material quality only; its desk,
  packaging, pinboard, objects, and camera framing were prohibited.
...
The first output passed the semantic, duplicate, text, logo, and artifact gate.

### 2023 - First incubation

Reference role: `about-journey-2023.webp` supplied subject-stage and palette
guidance only; the generated room, viewpoint, arrangement, and composition had
to be new.
...
The first output was rejected because cabinet stickers and paper marks resembled
synthetic text. The accepted output used this targeted correction while
preserving the scene:

```text
Remove every sticker, label, note, letter-like mark, number-like mark, and pseudo-text from cabinet fronts, bottles, papers, boards, and containers. Make cabinet fronts completely blank. Replace paper drawings with simple non-symbolic colour blocks, straight lines, circles, and packaging silhouettes that cannot be mistaken for writing. Keep the early product prototype pouch completely blank. Preserve the exact incubator room, eye-level framing, lighting, blue cabinetry, planning table, vessels, samples, object positions, perspective, crop, palette, and early-stage meaning. Add no text, logos, people, objects, gradients, neon, or futuristic technology.
```
...
- `about-journey-2024.webp`: collection lighting, palette, cacao, botanical,
  and material anchor; its arrangement was prohibited.
- `raw-radicles-holy-sin.webp`, `raw-radicles-wrath-relief.webp`, and
  `raw-radicles-smart-sin.webp`: product-form and colour guidance only; their
  cutouts, labels, logos, text, and pack artwork were prohibited.
...
Subject: Finished chocolate pieces, cacao pods and beans, measured Ayurvedic botanical ingredients, three structurally credible premium package silhouettes with completely blank surfaces, and restrained retail-presentation materials.
...
The first output passed the semantic, duplicate, text, logo, packaging-geometry,
and artifact gate.

### 2025 - MUTBI incubation and national grant

Reference role: `about-journey-2025.webp` supplied prototype-development and
measurement guidance only. Institutional supporter marks were deliberately not
provided to the generator and do not appear in the result.
...
Subject: Developed physical consumer-product prototype, precision measurement equipment, compact technical test fixture, neutral review sheets with only abstract non-readable colour blocks and geometry, one sealed validation sample, and a distinct production-ready sample suggesting manufacturing transfer.
...
Constraints: no people, hands, money, award trophies, ceremonial cheque, cacao launch scene, institution logos, government emblems, readable grant documents, letters, numbers, pseudo-text, copied MUTBI or NIDHI photography, trademarks, watermark, duplicated instruments, gradients, neon, or fantasy technology.
```

The first output was rejected because its review-wall headings resembled fake
text. The accepted output used this targeted correction:

```text
Remove every heading, word-like mark, letter-like mark, number-like mark, label, sticker, measurement marking, and pseudo-text from the whiteboard, charts, instruments, scale panel, notebook, papers, packaging, and containers. Replace the whiteboard with large simple rectangles, circles, straight lines, and solid colour bars without axes, legends, tick marks, or tiny marks. Make device displays and control panels blank dark glass. Preserve the exact room, composition, prototype progression, measurement equipment, validation fixture, sealed sample, production-ready samples, lighting, palette, crop, and manufacturing-handoff meaning. Add no text, logos, institutions, people, money, awards, objects, gradients, neon, or futuristic technology.
```
...
- `about-journey-2026.webp`: operating-stage and material guidance only; its
  desk-led composition was prohibited.
- `branding-workshop-02-1440.webp`, `marketing-primary-1440.webp`, and
  `ecommerce-primary-1440.webp`: semantic references for identity, campaign,
  and commerce cues only; their compositions and objects were prohibited.
...
Subject: Identity-review wall made only from abstract geometric colour cards and material swatches; campaign-planning rail with completely blank layouts and simple non-readable solid-shape charts; e-commerce and fulfilment zone with unbranded device silhouettes, generic blank packaging, and dispatch-ready parcels.
...
The first output passed the artifact gate but the centre rail read as a second
identity board. The accepted output used this semantic correction:

```text
Preserve the exact architectural studio, camera position, perspective, lighting, palette, left identity wall, right fulfilment shelves, packing table, blank laptop, packages, floor, and room geometry. Change only the central illuminated rail into campaign planning: completely blank campaign-media layouts, small product-photography contact sheets with generic unbranded objects, solid-block audience and allocation diagrams, and bar-chart groups made only from large rectangles without axes, legends, tick marks, labels, numbers, or tiny marks. Add no text, pseudo-letters, numbers, logos, UI, people, devices, floating interfaces, gradients, neon, or futuristic technology.
```

Derivative settings for all five selected masters:

- Master format: PNG.
- Delivery format: WebP.
- Delivery dimensions: 1536 x 1024.
- WebP quality: 86.
- WebP effort: 6.
- Resampling: Lanczos 3.
- SHA-256 prefixes: 2022 `8dbc0cdb2b33`; 2023 `ab22aa3633a1`; 2024
  `96adc7325e64`; 2025 `f015fc0332dd`; 2026 `4ef966edcc23`.
